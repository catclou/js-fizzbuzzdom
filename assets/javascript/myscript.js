...
for (let i = 1; i<=100; i++) {
    ...
    if (i % 3 == 0 && i % 5 == 0) {
        ...
        document.getElementById("numeri").innerHTML += `<div class="bg_fizzbuzz d-flex col-xl-2 fs-1 mx-2 my-2 justify-content-center align-items-center" style="width: 170px; height: 170px;">FizzBuzz</div>`;
    // 2) Per i multipli di 3 stampi "Fizz" al posto del numero;
        ...
        document.getElementById("numeri").innerHTML += `<div class="bg_fizz d-flex col-xl-2 fs-1 mx-2 my-2 justify-content-center align-items-center" style="width: 170px; height: 170px;">Fizz</div>`;
    // 3) Per i multipli di 5 stampi "Buzz" al posto del numero;
        ...
        document.getElementById("numeri").innerHTML += `<div class="bg_buzz d-flex col-xl-2 fs-1 mx-2 my-2 justify-content-center align-items-center" style="width: 170px; height: 170px;">Buzz</div>`;
    } else {
        console.log(i);
        // 5) Appendi un elemento HTML in un container del DOM, con il numero o la stringa corretta;
        document.getElementById("numeri").innerHTML += `<div class="bg_standard d-flex col-xl-2 fs-1 mx-2 my-2 justify-content-center align-items-center" style="width: 170px; height: 170px;">${i}</div>`;
    }
}
